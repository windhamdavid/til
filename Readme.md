...
![vi-2](/img/zulu.png)
 My page is referring to the database and computer operating system and not the Zulu philosophy of a universal bond of sharing that connects all humanity. [https://en.wikipedia.org/wiki/Ubuntu](https://en.wikipedia.org/wiki/Ubuntu_(philosophy)
