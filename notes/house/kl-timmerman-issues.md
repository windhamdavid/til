...
- Timeliness 🐢
  ...
  - took almost a year - **10 months** if you account for the truss manufacturing delay to complete the project
- very little inspection of work - **NO** final inspection
- General contractor has only been by the site a couple times to check up on work
  - after the trusses were installed and after the interior paint
...
- Communication lackluster
  - Inconsistent notice of subcontractors arriving onsite
    - sometimes no notice and sometimes just short notice
- Broken Sewer Line
...
- Subcontractors
  ...
  - paint dumped in bushes and spilled on house during brush cleaning
...
- installed tile inset the wrong directiom
...
- didn't patch the ceiling until months after the trusses installed
  - $$$ heating cost to heat ceiling area
...
- had to repaint from bad work on drywall
  - still have bubbling in the paint in spots 👈🏻
...
- put the new carpet down before the contractors had finished the other work
  - carpet has visible seams
  - carpet doesn't extend far enough under baseboards
- didn't caulk the quartz top to the tile inside the shower
  - we did it ourselves 👈🏻
...
- ~~bad water pressure~~
  ...
  - check sewer leak?
  - ~~had failed to clean dirt from heads on faucets.~~
- bathtub not properly installed based on manufacturers manual 👈🏻
  - slides around
