...
![zulu](https://davidwindham.com/til/img/zulu.png)  
...
I'm hoping it'll help me keep my bookmarks as little less cluttered and it'll leave my [desk page](https://davidwindham.com/desk) free for longer form essays. I'll keep the LOG in the [README](https://davidwindham.com/code/til/src/master/README.md), add a [help page](/help), and some [vi cheat sheets](/docs/shell/vi) to get started because I'm always forgetting some of them.

Here's a map 👇🏼

[![md-graph map](https://davidwindham.com/til/img/til.jpg)](https://davidwindham.com/til/img/til.jpg)
...
- [ ] **Sync Apple Reminders → [lists/todo.md](lists/todo.md)** — I keep real todos in Apple Reminders but rarely mirror them here. Find an easy export/sync (a Shortcut, or a small script via `reminders-cli` / AppleScript → markdown) so the [Todo list](https://davidwindham.com/til/lists/todo) isn't hand-maintained.
- [ ] **Sync Last.fm → [lists/now/listening.md](lists/now/listening.md)** — pull recent scrobbles from the Last.fm API and render to markdown so [Now / Listening](https://davidwindham.com/til/lists/now/listening) updates itself.
...
- [ ] **Import my other sites as markdown for the davo-bot corpus** — convert my other sites (davidwindham.com, davidwindham.com, srh, …) to markdown and feed them into the [ralph](https://davidwindham.com/code/ralph) RAG / vector pipeline, so the AI [davo-bot](https://davidwindham.com/til/ai) answers from my whole web presence, not just this TIL site — more complete retrieval and citations.

## Log

- 26/06/06 - reworking the [AI page](https://davidwindham.com/til/ai): dropping Markprompt/OpenAI for a self-hosted assistant — Claude (Haiku) + local vector search over my own notes/docs/lists/posts, answers that link back to the source pages, as a little pop-up "Clippy" widget I can drop on any of my sites. Only answers from my stuff. Backend rides on my [ralph](https://davidwindham.com/code/ralph) RAG/MCP server (SQLite + sqlite-vec + local Ollama embeddings).
...
- 23/12/10 - modified blog layout - log @ [https://davidwindham.com/til/help](https://davidwindham.com/til/help)
- 23/11/12 - update 2.4.3 👉🏼 3.0.0 and React 17.0.2 👉🏼 18.2.0
- 23/08/18 - added private and draft notes with git controls. log @ [https://davidwindham.com/til/help](https://davidwindham.com/til/help)
- 23/05/05 - added AI page @ [https://davidwindham.com/til/ai](https://davidwindham.com/til/ai)
- 23/02/11 - mv master to main / migrate to [woozie](https://davidwindham.com/til/docs/computers/woozie/)
